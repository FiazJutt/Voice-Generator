...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _saveToDevice(AudioModel audio) async {
    ...
    if (provider.error != null && (provider.error!.contains('Permission') ||
      ...
      if (status.isGranted || status.isLimited) {
        ...
        _showSnackBar('Storage permission denied. Please grant permission in app settings.',
            duration: 4);
      }
    } else {
      _handleProviderMessages(provider);
  ...
  void _showSnackBar(String message, {bool isSuccess = false, int duration = 3}) {
  ...
  void _showDetailsDialog(AudioModel audio) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Audio Details', style: TextStyle(color: AppColors.textPrimary, fontSize: 20, fontWeight: FontWeight.bold)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          ...
          children: [
            ...
            _buildDetailRow('Voice', audio.voice),
            const SizedBox(height: 12),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Voice Generator', style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: AppColors.background,
        elevation: 0,
      ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Generate', style: TextStyle(fontWeight: FontWeight.w600)),
      ),
    );
  }
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.graphic_eq_rounded, size: 80, color: AppColors.textSecondary.withOpacity(0.5)),
        ...
        return Container(
          ...
          child: ListTile(
            ...
            subtitle: Padding(
              ...
              child: Text(
                '${audio.voice} • ${_formatDate(audio.createdAt)}',
